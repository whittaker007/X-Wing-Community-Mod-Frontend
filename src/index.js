...
const App = () => (
  <div className="squad-container">
    ...
    <div className="squad-item-container minified">
      <div className="squad-item-ship galactic-empire">
        ...
        <div className="id-container">
          ...
          <div className="pilot unique">Darth Vader</div>
        </div>
    ...
    <div className="squad-item-container no-ship no-pilot">
      <div className="squad-item-ship galactic-empire">
        <div className="points-container">
          <div className="faction">
            <i className="xwing-miniatures-font xwing-miniatures-font-empire"></i>
    ...
    <div className="squad-item-container no-pilot">
      <div className="squad-item-ship galactic-empire">
